# Masses are according to the MR (Menntaskólinn Í Reykjavík)'s offically taught Periodic Table of Elements or 'Lotukerfi'.
# Each element is represented by their letter(s) in the same Periodic Table of Elements. So Hydrogen = H
